...
const staticPaths = ['/release-date', '/demo', '/platforms', '/beginner-guide', '/guides', '/export', '/tools', '/tools/platform-picker', '/tools/romance-gift-finder', '/farming', '/magic', '/character-creator', '/shapeshifting', '/items', '/environment', '/behind-the-scenes', '/activities', '/characters', '/moonlight-peaks-vs-stardew-valley', '/nokturna', '/map', '/romance', '/cheats', '/about', '/privacy', '/previews', '/faq', '/locations', '/families', '/compare'];
